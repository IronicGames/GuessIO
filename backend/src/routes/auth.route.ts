...
import { guestLoginSchema, nameUpdateSchema } from '@middleware/validation/validation.schemas';
...
router.patch('/name', requireAuth, validate(nameUpdateSchema), updateName);
